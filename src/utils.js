...
const css = function (name) {
  ...
  switch (name) {
    case 'VersionInfo':
      return 'AIPRM__flex AIPRM__py-3 AIPRM__px-3 AIPRM__items-center AIPRM__gap-3 AIPRM__rounded-md hover:AIPRM__bg-gray-500/10 AIPRM__transition-colors AIPRM__duration-200 AIPRM__text-white AIPRM__cursor-pointer AIPRM__text-sm';
    case 'ExportButton':
      return 'AIPRM__flex AIPRM__py-3 AIPRM__px-3 AIPRM__items-center AIPRM__gap-3 AIPRM__rounded-md hover:AIPRM__bg-gray-500/10 AIPRM__transition-colors AIPRM__duration-200 AIPRM__text-white AIPRM__cursor-pointer AIPRM__text-sm';
    case 'column':
    ...
    case 'card':
      return 'AIPRM__flex AIPRM__flex-col AIPRM__gap-2 AIPRM__w-full AIPRM__bg-gray-50 dark:AIPRM__bg-white/5 AIPRM__p-4 AIPRM__rounded-md hover:AIPRM__bg-gray-200 dark:hover:AIPRM__bg-gray-900 AIPRM__text-left';
    case 'p':
    ...
    case 'paginationButton':
      return 'AIPRM__px-4 AIPRM__py-2 AIPRM__font-medium AIPRM__bg-gray-100 hover:AIPRM__bg-gray-200 dark:AIPRM__bg-gray-700 dark:AIPRM__border-gray-600 dark:AIPRM__text-gray-400 dark:hover:AIPRM__text-white';
    case 'continueButton':
      return 'AIPRM__py-2 AIPRM__font-medium AIPRM__bg-gray-100 hover:AIPRM__bg-gray-200 dark:AIPRM__bg-gray-600 dark:AIPRM__border-gray-700 dark:hover:AIPRM__bg-gray-900 AIPRM__bg-gray disabled:AIPRM__text-gray-300 disabled:hover:AIPRM__bg-transparent AIPRM__rounded-l-md AIPRM__px-4';
    case 'continueActionSelect':
      return 'AIPRM__bg-gray-100 AIPRM__border-0 AIPRM__border-l AIPRM__text-sm AIPRM__rounded-r-md AIPRM__block AIPRM__w-2 dark:AIPRM__bg-gray-600 AIPRM__border-gray-200 dark:AIPRM__border-gray-500 dark:hover:AIPRM__bg-gray-900 dark:AIPRM__placeholder-gray-400 dark:AIPRM__text-white hover:AIPRM__bg-gray-200 focus:AIPRM__ring-0 focus:AIPRM__border-gray-200 AIPRM__pr-6';
    case 'action':
